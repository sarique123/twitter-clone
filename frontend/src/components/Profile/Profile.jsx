    ...
    return (
        <div>
            <section className={`bg-white z-50 flex items-center sticky top-0 bg-opacity-95`}>
                ...
                <h1 className='py-5 text-xl font-bold opacity-90 ml-5'>Mohammad Sarique</h1>
            </section>

            <section>
                <img src="https://cdn.pixabay.com/photo/2025/05/11/22/13/mountains-9594042_1280.jpg" alt="" className='w-[100%] h-[15rem] object-cover'/>
            </section>
            ...
            <section className='pl-6'>
                ...
                <div>
                    <div className='flex items-center'>
                        <h1 className='font-bold text-lg'>Mohammad Sarique</h1>
                        {true && <VerifiedIcon className='text-[#1d9bf0] ml-2' />}
                    </div>
                    <h1 className='text-gray-500'>@itz_sarique</h1>
                </div>

                <div className='mt-2 space-y-3'>
                    <p>Hello, I am Mohammad Sarique. Currently, I am pursuing MCA from MNNIT Allahabad</p>
